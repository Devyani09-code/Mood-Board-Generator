...
export default function HomePage() {
  return (
    <main className="grain min-h-[100dvh] overflow-hidden bg-[#13273f] text-[#e9o4c3]">
      <section className="relative min-h-screen px-6 pb-20 pt-7 sm:px-10 lg:px-16">
        <div className="mx-auto max-w-[1400px]">
          <header className="flex items-center justify-between border-b border-[#e9o4c3]/20 pb-5">
            <Link href="/" className="group flex items-center gap-3" data-testid="link-home-logo">
              <span className="flex h-10 w-10 items-center justify-center rounded-[12px] border border-[#e9o4c3]/30 bg-[#13273f] text-[#fef7e5] shadow-sm">
            ...
            <nav className="flex items-center gap-5 text-[11px] font-bold uppercase tracking-[.16em] sm:gap-8">
              <Link href="/sign-in" className="rounded-full border border-[#b7e1da]/30 px-4 py-2 transition-all hover:border-[#c0d6ed] hover:bg-[#e9o4c3] hover:text-[#13273f]" data-testid="link-sign-in">Sign in</Link>
            </nav>
          </header>

          <div className="grid items-end gap-12 pt-20 lg:grid-cols-[1.05fr_.95fr] lg:gap-20 lg:pt-28">
            <div className="relative z-10 max-w-[720px]">
              <h1 className="reveal reveal-delay-1 serif mt-8 max-w-[760px] text-[clamp(4rem,9vw,9.2rem)] leading-[.84] tracking-[-.065em] text-[#e9o4c3]">
                Stage<br /><em>your</em> ideas.
              </h1>
              <p className="reveal reveal-delay-2 mt-9 max-w-[470px] text-[15px] leading-7 text-[#e9o4c3] sm:text-[17px]">
              ...
              <div className="reveal reveal-delay-3 mt-10 flex flex-wrap items-center gap-4">
                <Link href="/sign-up" className="group flex items-center gap-3 rounded-full bg-[#bf5114] px-6 py-3.5 text-[11px] font-bold uppercase tracking-[.15em] text-[#13273f] transition-all hover:-translate-y-0.5 hover:bg-[#4e0000] hover:text-[#e9o4c3]" data-testid="link-start-ritual">
                  Let's Begin!! <ArrowRight size={15} className="transition-transform group-hover:translate-x-1" />
                </Link>
                <a href="#ritual" className="flex items-center gap-2 px-2 py-3 text-[11px] font-bold uppercase tracking-[.15em] text-[#e9o4c3] transition-colors hover:text-[#bf5114]" data-testid="link-see-how">
            ...
            <div className="reveal reveal-delay-2 relative mx-auto w-full max-w-[510px] lg:mb-[-54px]">
              <div className="absolute -left-8 top-12 hidden h-16 w-16 rounded-full border border-[#e9o4c3]/20 lg:block" />
      ...
      <section id="ritual" className="relative border-t border-[#13273f]/20 bg-[#e9o4c3] px-6 py-24 text-[#4e0000] sm:px-10 lg:px-16">
        <div className="mx-auto max-w-[1400px]">
          <div className="grid gap-14 lg:grid-cols-[.55fr_1fr] lg:gap-24">
            <div>
              <span className="eyebrow text-[#bf5114]">A gentler starting point</span>
      ...
      <footer className="flex flex-col justify-between gap-4 border-t border-[#e9o4c3]/20 bg-[#13273f] px-6 py-7 text-[10px] font-bold uppercase tracking-[.16em] text-[#e9o4c3] sm:flex-row sm:px-10 lg:px-16">
