...
export default function HomePage() {
  return (
    <main className="grain min-h-[100dvh] overflow-hidden bg-[#390404] text-[#c1dbe8]">
        ...
        <div className="mx-auto max-w-[1400px]">
          ...
          <div className="grid items-end gap-12 pt-20 lg:grid-cols-[1.05fr_.95fr] lg:gap-20 lg:pt-28">
            <div className="relative z-10 max-w-[720px]">
              ...
              <p className="reveal reveal-delay-2 mt-9 max-w-[470px] text-[15px] leading-7 text-[#c1dbe8] sm:text-[17px]">
              ...
              <div className="reveal reveal-delay-3 mt-10 flex flex-wrap items-center gap-4">
                ...
                <a href="#ritual" className="flex items-center gap-2 px-2 py-3 text-[11px] font-bold uppercase tracking-[.15em] text-[#fef7e5] transition-colors hover:text-[#2c4971]" data-testid="link-see-how">
            ...
            <div className="reveal reveal-delay-2 relative mx-auto w-full max-w-[510px] lg:mb-[-54px]">
              <div className="absolute -left-8 top-12 hidden h-16 w-16 rounded-full border border-[#c1dbe8]/20 lg:block" />
              <div className="relative rotate-[3.5deg] overflow-hidden border-[10px] border-[#e1e2d9]/70 bg-[#8295a0] shadow-[18px_25px_0_rgba(92,26,3,.12),0_32px_50px_rgba(92,26,3,.22)]">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center bg-[#390404]/20 p-8 text-center text-[#fef7e5]">
      ...
      <section id="ritual" className="relative border-t border-[#390404]/20 bg-[#fef7e5] px-6 py-24 text-[#390404] sm:px-10 lg:px-16">
        <div className="mx-auto max-w-[1400px]">
          <div className="grid gap-14 lg:grid-cols-[.55fr_1fr] lg:gap-24">
            <div>
              <span className="eyebrow text-[#2c4971]">A gentler starting point</span>
            ...
            <div className="grid gap-0 sm:grid-cols-3">
              {[
                ...
                <div key={number} className={`border-t border-[#390404]/25 py-6 sm:border-l sm:border-t-0 sm:pl-6 ${index > 0 ? 'mt-4 sm:mt-0' : ''}`} data-testid={`card-ritual-step-${number}`}>
                  <span className="text-[11px] tracking-[.18em] text-[#2c4971]">{number}</span>
      ...
      <footer className="flex flex-col justify-between gap-4 border-t border-[#c1dbe8]/20 bg-[#390404] px-6 py-7 text-[10px] font-bold uppercase tracking-[.16em] text-[#c1dbe8] sm:flex-row sm:px-10 lg:px-16">
        ...
        <span className="text-[#2c4971]">for ideas in their early light</span>
      </footer>
    </main>
  );
}
